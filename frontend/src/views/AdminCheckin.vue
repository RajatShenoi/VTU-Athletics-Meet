<template>
    ...
    <div class="mb-2">
        Use the below input field to search for the college you'd like to checkin using its name or code and click "find" to search for available rooms.
    </div>
    <div class="input-group mb-2">
        ...
        <RouterLink :to="`/admin/checkin/${collegeCode}`" :class="{ disabled: buttonDisabled }" class="btn btn-success" type="button" id="submit-button" :disabled="buttonDisabled">Check in</RouterLink>
